...
const wrapUpStep = createStep({
  ...
  execute: async ({ inputData, getInitData }) => {
    ...
    console.log(`Labeled issue #${issueNumber} with: ${labels.join(', ')}`);
    ...
    await octokit.rest.issues.createComment({
      ...
      issue_number: Number(issueNumber),
      body: 
      `Thank you for reporting this issue! We have labeled it for the ${inputData.squad} and we will look into it as soon as possible.\n\n`+
